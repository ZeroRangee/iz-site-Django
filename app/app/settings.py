...
SECRET_KEY = 'django-insecure-g0th$)r_sei2lc4iw9qvjfl@cotp=p-y1z&bfr@7883+4rbigt'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'app.context_processor.singup',
                'app.context_processor.singin',
                'app.context_processor.applicationadd',
